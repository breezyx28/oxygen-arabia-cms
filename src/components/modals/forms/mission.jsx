...
import { useCreateMissionMutation } from 'src/redux/endpoints/missions';
import { MissionValidation } from 'src/logic/Validation/missionValidation';
...
export default function MissionModal() {
  ...
  const [addMission, { data, isLoading, isSuccess, error, isError }] = useCreateMissionMutation();

  const { controller, displayError } = new MissionValidation();
  const {
    register,
    handleSubmit,
    reset,
