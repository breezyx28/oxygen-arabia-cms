...
import { useCreateProductMutation } from 'src/redux/endpoints/products';
...
export default function HeroModal() {
  ...
  const onSubmit = async (values) => {
    values = { ...values, variations, image_file: imageUpload };
      ...
      <BootstrapDialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open} fullWidth>
        ...
        <DialogActions>
          <Button
            autoFocus
            onClick={() => {
              document.getElementById('hero-form').click();
