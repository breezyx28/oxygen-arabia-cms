...
import { useCreatePartnerMutation } from 'src/redux/endpoints/partners';
...
export default function PartnerModal() {
  ...
  const [addPartner, { data, isLoading, isSuccess, error, isError }] = useCreatePartnerMutation();
