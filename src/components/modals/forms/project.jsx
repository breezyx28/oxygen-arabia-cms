...
import { useCreateProjectMutation } from 'src/redux/endpoints/projects';
...
export default function ProjectModal() {
  ...
  const [addProject, { data, isLoading, isSuccess, error, isError }] = useCreateProjectMutation();
