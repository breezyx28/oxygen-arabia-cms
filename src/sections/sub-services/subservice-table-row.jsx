...
import { useDeleteSubserviceMutation } from 'src/redux/endpoints/sub-services';
import SubserviceUpdateModal from 'src/components/modals/update/subServiceUpdate';
...
export default function SubserviceTableRow({
  ...
  const [deleteSubservice, { data, isLoading, isError }] = useDeleteSubserviceMutation();
