...
import PartnerTableHead from '../partner-table-head';
import TableEmptyRows from '../table-empty-rows';
import PartnerTableToolbar from '../partner-table-toolbar';
import { emptyRows, applyFilter, getComparator } from '../utils';
import { useAllPartnersQuery } from 'src/redux/endpoints/partners';
import PartnerModal from 'src/components/modals/forms/partner';
...
export default function PartnersPage() {
  const { data: partners, isLoading, isFetching } = useAllPartnersQuery();
  ...
  const handleSelectAllClick = (event) => {
    if (event.target.checked) {
      const newSelecteds = partners?.map((n) => n.id);
  ...
  const iframeUrl = "https://oxygenarabia.com/#partners"; // Replace with your desired URL
      ...
      <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
        ...
        <Stack direction="column" alignItems="start" justifyContent="space-between">
          ...
          <Typography variant="caption" color="textSecondary" mt={2}>
            Partners page were you can add, delete and update existed partner logo.
          </Typography>
        </Stack>
